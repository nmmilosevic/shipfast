      ...
      <div className="grid gap-10 lg:grid-cols-[1.06fr_0.94fr] lg:items-center">
        <div>
          ...
          <p className="mt-8 max-w-2xl text-base font-extralight leading-8 text-muted md:text-lg">
            You have been carrying it around for months. Maybe it is a client portal, a tool for your team, a booking product, or a small app people would gladly pay for. We help you shape it, build it, launch it, and own it.
          </p>
          <p className="mt-5 max-w-2xl text-base font-light leading-8 text-foreground">
            No technical document required. No jargon. Just a clear path from rough idea to working product.
          </p>
          <div className="mt-10 flex flex-col gap-3 sm:flex-row">
            ...
            <Button asChild variant="secondary" size="lg">
              <Link href="/how-it-works">See how we make it real</Link>
            </Button>
          </div>
        ...
        <div className="paper-panel rounded-2xl p-5 md:p-7">
